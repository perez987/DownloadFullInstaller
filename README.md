...
**Note**: If you prefer the version built with Swift 6, that runs on macOS 15 or later, get the project code from the `main` branch of the repository or the version 5.x.x from the [releases](https://github.com/perez987/DownloadFullInstaller/releases) page.
